          ...
          <group name="f57d262c2aa44061846a12a5a8f3c5ddfbx" rotation={[Math.PI / 2, 0, 0]}>
            <group name="Object_2">
              <group name="RootNode">
                ...
                <group name="pDisc1" position={[0, -0.064, 0]} scale={14.985} onPointerOver={()=>setHovered(true)} onPointerOut={()=>setHovered(false)}>
                  <mesh name="pDisc1_lambert3_0" geometry={nodes.pDisc1_lambert3_0.geometry} material={materials.lambert3} />

                </group>
                <group name="pCylinder29" position={[0.031, 1.5, 0.102]} onPointerOver={()=>setHovered(true)} onPointerOut={()=>setHovered(false)}>
                ...
                <group name="pPlane182" position={[9.34, 0.595, -5.758]} rotation={[-0.098, -1.01, -1.63]} scale={[0.156, 0.202, 0.101]} onPointerOver={()=>setHovered(true)} onPointerOut={()=>setHovered(false)}>
...
<group name="pCube6" position={[-0.245, 0.313, 0.566]} onPointerOver={()=>setHovered1(true)} onPointerOut={()=>setHovered1(false)} onClick={()=>window.location.href=('/Educationhub')}>
  <mesh name="pCube6_lambert7_0" geometry={nodes.pCube6_lambert7_0.geometry} material={hovered1 ? materials.lambert7 :materials.lambert3}>
  </mesh>
</group>
