...
import Story from "./ForestStory/Story";
import Map from   "./StoryBook/Map";
import ForestStory from "./Components/Comparator";
import Notfound from "./NotFound";
import Section  from './EducationHub/Section'
  const mockData = {
      forest_plants: [
        {
          name: "Oak Tree",
...
const dynamicRoutes = mockData.forest_plants.map((section, index) => ({
  path: `/plant/${section.name.toLowerCase().replace(/ /g, '-')}`,
